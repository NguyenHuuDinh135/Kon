...
import { Gemini } from '@workspace/ui/components/ui/svgs/gemini'
import { Replit } from '@workspace/ui/components/ui/svgs/replit'
import { MagicUI } from '@workspace/ui/components/ui/svgs/magic-ui'
import { VSCodium } from '@workspace/ui/components/ui/svgs/vs-codium'
import { MediaWiki } from '@workspace/ui/components/ui/svgs/media-wiki'
import { GooglePaLM } from '@workspace/ui/components/ui/svgs/google-palm'
            ...
            <div className="relative">
                ...
                <div className="flex gap-3 border-t border-dashed pt-6">
                    <Button
                        ...
                        variant="secondary"
                        size="sm"
                        className="gap-1 pe-2 shadow-none">
                        <Link href={link}>
                            Learn More
                            <ChevronRight className="ms-0 !size-3.5 opacity-50" />
                        </Link>
                    </Button>
                </div>
            </div>
