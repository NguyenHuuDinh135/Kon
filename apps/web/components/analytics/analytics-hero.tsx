  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-zinc-800/50 bg-zinc-950 p-8 md:p-12">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-20 top-10 h-60 w-60 rounded-full bg-indigo-600/15 blur-[80px]" />
        <div className="absolute -bottom-10 left-1/3 h-48 w-48 rounded-full bg-emerald-500/10 blur-[60px]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        >
          Revenue forecasting, RFM scoring, customer lifetime value analysis,
